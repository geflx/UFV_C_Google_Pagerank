...
#include <stdlib.h>
#include <string.h>
//Desenvolvido por Gabriel Felix em 07/09/2018
//github.com/geflx
...
int main(){
    ...
    /////////////// Escrevendo na tela a ordem do Pagerank por valor /////////////////
    int j=0;
    double maior=0;
    int indiceMaior=0;
    for(j=0;j<numeroPaginas;j++){
    	for(i=0;i<numeroPaginas;i++){  //Aqui olhamos qual é a pagina com maior PR, imprimimos ela e substituimos por 0.
    		if (minhaAmostra[i].valorAtual>maior){
    			indiceMaior=i;
    			maior= minhaAmostra[i].valorAtual;
    		}
    	}
    	printf("%d\n",indiceMaior);
    	minhaAmostra[indiceMaior].valorAtual=0;
    	indiceMaior=0;
    	maior=0;
    }
